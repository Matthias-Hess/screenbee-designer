...
export class ExportManager {
  ...
  static exportToArduino(project: Project): ArduinoExport {
  ...
  private static sanitizePropertiesForESP32(obj: ScreenObject): Record<string, any> {
  ...
  private static generateArduinoHeader(project: Project, className: string): string {
...
private:
  ...
  private static generateArduinoImplementation(project: Project, className: string): string {
    const screensData = JSON.stringify(this.exportToESP32(project), null, 2)

    return `#include "${className}.h"

// Project data generated by ScreenBee
...
int ${className}::getScreenCount() {
  ...
  private static generateArduinoReadme(project: Project): string {
    return `# ${project.name} - Arduino Project

This Arduino project was generated by ScreenBee, a web-based screen editor for embedded displays.
...
## Support
This code was generated by ScreenBee. For issues with the generated code,
