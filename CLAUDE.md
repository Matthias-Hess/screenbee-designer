...
Playwright `e2e/` suite, `hil/epaper/orchestrator.js`, and
`hil/android/orchestrator.js` - see `hil/README.md` for what each one
...
fixture (`hil/epaper/fixtures/build-comprehensive-test.js`, or the
equivalent under `hil/android/fixtures/` once one exists) before considering
the task finished - not thrown away. State explicitly, when reporting a
